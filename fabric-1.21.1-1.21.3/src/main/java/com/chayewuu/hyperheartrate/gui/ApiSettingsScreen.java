 ...
 * </ol>
 */
public class ApiSettingsScreen extends BaseModScreen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawCenteredTextWithShadow(this.textRenderer, "当前: " + addr, centerX, panelY + PANEL_HEIGHT - 18, 0xFF66CCFF);
    ...
    private void renderHelpPopup(DrawContext context, int mouseX, int mouseY) {
        ...
        textY += 4;
        context.drawText(this.textRenderer, "包路径: com.chayewuu.hyperheartrate.api", textX, textY, textColor, false);
        textY += 12;
