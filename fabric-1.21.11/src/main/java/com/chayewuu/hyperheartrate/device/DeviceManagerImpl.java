...
import com.chayewuu.hyperheartrate.device.windows.DotnetBleConnector;
import com.chayewuu.hyperheartrate.device.windows.DotnetBleScanner;
import com.chayewuu.hyperheartrate.device.windows.WindowsBleAdapter;
...
public class DeviceManagerImpl implements DeviceManager {
    ...
    public void shutdown() {
        ...
        if (scanner instanceof com.chayewuu.hyperheartrate.device.windows.WindowsBleScanner windowsScanner) {
            windowsScanner.shutdown();
        }
        if (connector instanceof com.chayewuu.hyperheartrate.device.windows.WindowsBleConnector windowsConnector) {
