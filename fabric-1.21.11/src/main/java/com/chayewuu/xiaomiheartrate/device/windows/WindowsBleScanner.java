...
import com.chayewuu.xiaomiheartrate.device.windows.win32.BLUETOOTH_DEVICE_INFO;
import com.chayewuu.xiaomiheartrate.device.windows.win32.BLUETOOTH_DEVICE_SEARCH_PARAMS;
 ...
 * {@link com.chayewuu.xiaomiheartrate.device.windows.win32.BluetoothLELibrary} 的 TODO）。
...
public class WindowsBleScanner implements BleScanner {
     ...
     * <p>仅在设备受支持（{@link com.chayewuu.xiaomiheartrate.device.DeviceFilter}）时上报。</p>
     *
    ...
    private void reportDevice(BLUETOOTH_DEVICE_INFO info) {
        ...
        DeviceType type = com.chayewuu.xiaomiheartrate.device.DeviceFilter.getDeviceType(name);
    ...
    /**
     * 关闭扫描器，释放后台线程池。
     * <p>由 {@link com.chayewuu.xiaomiheartrate.device.DeviceManager} 在 Mod 卸载时调用。</p>
     */
