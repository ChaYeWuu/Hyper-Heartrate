 ...
 * 非小米/Redmi 设备统一归类为 {@link DeviceType#STANDARD_GATT}（通用心率广播设备），
 ...
 *     <li>其余统一归类为 {@link DeviceType#STANDARD_GATT}（通用心率广播设备）。</li>
 * </ul>
 */
public final class DeviceFilter {
    ...
    /**
     * 判断设备是否受支持。
     * <p>所有支持心率广播的设备均受支持，此方法始终返回 {@code true}
     *（{@code null} 设备除外）。</p>
     *
     * @param device 待判定设备
    ...
    /**
     * 判断设备名称是否匹配受支持的设备。
     * <p>所有设备均受支持，此方法始终返回 {@code true}。</p>
     *
     * @param name 设备名称
    ...
    /**
     * 根据设备名称推断设备类型。
     * <p>匹配方式为大小写不敏感的前缀匹配。非小米/Redmi 设备
     * 统一归类为 {@link DeviceType#STANDARD_GATT}（通用心率广播设备）。</p>
     *
     * @param name 设备名称
     * @return 设备类型；非小米/Redmi 设备返回 {@link DeviceType#STANDARD_GATT}
     */
