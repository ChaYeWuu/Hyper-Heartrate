 ...
 * <h2>何时触发</h2>
 * <p>
 * 当 BLE 心率设备上报新的心率测量值时，由 {@link com.chayewuu.xiaomiheartrate.heart.HeartRateManager#updateHeartRate(int)}
 * 触发。每次心率采样都会产生一个事件实例。
 * </p>
 *
 * <h2>携带数据</h2>
 ...
 * <h2>如何监听</h2>
 * <p>
 * 通过 {@link com.chayewuu.xiaomiheartrate.heart.HeartRateListener#onHeartRateChanged(int, long)}
