...
/**
 * Mod 按键绑定注册（1.21.6-1.21.10 版本）。
 * <p>
 * 1.21.6-1.21.10 的 {@code KeyBinding} 构造函数使用 String category
 * （{@code KeyBinding.Category} record 在 1.21.11 才引入）。
 * </p>
 *
...
public final class ModKeyBindings {
    ...
    /** 按键类别字符串 */
    private static final String CATEGORY = "key.categories." + HeartRateMod.MOD_ID;
