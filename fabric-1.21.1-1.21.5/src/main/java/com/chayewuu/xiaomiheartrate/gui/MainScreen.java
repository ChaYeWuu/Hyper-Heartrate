...
public class MainScreen extends BaseModScreen {
    ...
    private ButtonWidget guiSettingsButton;
    private ButtonWidget heartRateSettingsButton;
    private ButtonWidget apiSettingsButton;
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        ModFontManager.centeredText(context, ModFontManager.getFont(), "作者@茶叶Wuu", this.width / 2, panelY + PANEL_HEIGHT - 12, 0xFF888888);
    ...
    private void renderPanel(DrawContext context) {
        fillRoundedPanel(context, panelX, panelY, PANEL_WIDTH, PANEL_HEIGHT, CORNER_RADIUS);
    }
    ...
    public static void fillRoundedPanel(DrawContext context, int x, int y, int width, int height, int radius) {
        ...
        fillRounded(context, x, y, width, height, bgColor, radius);
        drawRoundedOutline(context, x, y, width, height, borderColor, radius);
    }
