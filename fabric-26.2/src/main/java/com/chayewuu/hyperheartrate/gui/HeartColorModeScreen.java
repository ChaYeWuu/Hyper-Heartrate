...
public class HeartColorModeScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        // 面板
        MainScreen.fillRounded(graphics, panelX, panelY, PANEL_WIDTH, panelHeight, 0xE6121418, CORNER_RADIUS);
        MainScreen.drawRoundedOutline(graphics, panelX, panelY, PANEL_WIDTH, panelHeight, 0xFF3A3F4A, CORNER_RADIUS);
