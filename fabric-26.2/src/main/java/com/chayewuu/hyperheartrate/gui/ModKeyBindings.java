 ...
 * </p>
 *
 * <p>按键类别使用自定义类别 {@code key.categories.hyper-heartrate}，
...
public final class ModKeyBindings {
    ...
    /**
     * 打开主界面屏幕。
     * <p>使用 26.2 API {@code Minecraft.getInstance().gui.setScreen(...)} 切换屏幕。</p>
     */
    private static void openMainScreen() {
        ...
        minecraft.gui.setScreen(new MainScreen(Component.translatable("screen." + HeartRateMod.MOD_ID + ".main")));
    }
}
