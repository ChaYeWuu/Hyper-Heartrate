...
import com.chayewuu.hyperheartrate.device.NotificationCallback;
...
public class DotnetBleConnector implements BleConnector {
    ...
    /**
     * 设置心率通知回调。
     * <p>由 {@link com.chayewuu.hyperheartrate.device.DeviceManagerImpl} 在连接成功后调用，
     * 传入 {@link com.chayewuu.hyperheartrate.device.HeartRateNotificationHandler}。</p>
     *
     * @param callback 通知回调
     */
