...
import com.chayewuu.hyperheartrate.device.BleCharacteristic;
import com.chayewuu.hyperheartrate.device.BleConnector;
import com.chayewuu.hyperheartrate.device.BleDevice;
import com.chayewuu.hyperheartrate.device.ConnectionCallback;
import com.chayewuu.hyperheartrate.device.windows.win32.BTH_LE_GATT_CHARACTERISTIC;
import com.chayewuu.hyperheartrate.device.windows.win32.BTH_LE_GATT_SERVICE;
import com.chayewuu.hyperheartrate.device.windows.win32.BluetoothGattLibrary;
import com.chayewuu.hyperheartrate.device.windows.win32.Kernel32Library;
...
import com.chayewuu.hyperheartrate.device.windows.win32.SetupApiLibrary;
...
public class WindowsBleConnector implements BleConnector {
    ...
    /**
     * 关闭连接器，释放后台线程池。
     * <p>由 {@link com.chayewuu.hyperheartrate.device.DeviceManagerImpl} 在 Mod 卸载时调用。</p>
     */
