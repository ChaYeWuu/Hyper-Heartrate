 ...
 * 并推断对应的 {@link DeviceType}。所有支持心率广播的设备均会被上报，
 * 非小米/Redmi 设备统一归类为 STANDARD_GATT（通用心率广播设备），
...
public final class DeviceFilter {
    ...
    /**
     * 判断设备是否为支持心率广播的设备。
     * <p>所有非 null 设备均视为受支持（非小米/Redmi 设备归类为 STANDARD_GATT）。</p>
     *
     * @param device 待判定设备
     * @return {@code true} 表示该设备非 null（视为受支持）
     */
    ...
    /**
     * 判断设备名称是否为支持心率广播的设备。
     * <p>所有名称均视为受支持（非小米/Redmi 设备归类为 STANDARD_GATT）。</p>
     *
     * @param name 设备名称
     * @return 恒为 {@code true}
     */
    ...
    /**
     * 根据设备名称推断设备类型。
     * <p>匹配方式为大小写不敏感的前缀匹配。无法识别为小米/Redmi 的设备
     * 统一归类为 {@link DeviceType#STANDARD_GATT}（通用心率广播设备）。</p>
     *
     * @param name 设备名称
     * @return 设备类型；名称为空或无法识别为小米/Redmi 时返回 {@link DeviceType#STANDARD_GATT}
     */
